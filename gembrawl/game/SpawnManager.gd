...
class SpawnPoint extends RefCounted:
	...
	var assigned_player: IPlayer = null  # Player assigned to this spawn point
...
func get_spawn_point(player: IPlayer) -> Vector3:
...
func _assign_spawn_point(player: IPlayer) -> SpawnPoint:
...
func _get_farthest_spawn(spawns: Array[SpawnPoint], player: IPlayer) -> SpawnPoint:
...
func request_respawn(player: IPlayer, delay: float = -1.0) -> void:
...
func _start_respawn_timer(player: IPlayer, delay: float) -> void:
