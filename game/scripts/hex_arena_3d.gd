...
func _create_wall_mesh() -> void:
	# This would create vertical walls around the arena edge
	# For now, we'll skip this and focus on the floor
	pass
...
func generate_arena() -> void:
	...
	var hexes = HexGrid3D.get_hexes_in_radius(center, arena_radius)
...
func get_hex_at_position(world_pos: Vector3) -> Vector2i:
	return HexGrid3D.world_to_hex_3d(world_pos) 